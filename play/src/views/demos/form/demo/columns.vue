...
import { ref } from "vue"
import { HxForm, HxJsonView } from "@whhx/ui"
import type { FormField, FormExpose } from "@whhx/ui"
...
const formData = ref({
  ...
  workMode: "fulltime",
  skills: ["vue", "ts"],
  cityArea: ["shanghai", "pudong"],
  address: [],
  birthday: "1999-06-15",
  workPeriod: ["2023-01-01", "2025-06-01"],
  checkInTime: "2025-06-02 09:00:00",
  checkOutTime: "2025-06-02 18:00:00",
