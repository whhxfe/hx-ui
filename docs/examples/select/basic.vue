  ...
  <div class="demo-grid">
    ...
    <div class="demo-item">
      ...
      <HxSelect
        ...
        multiple
      />
      <p class="demo-value">值: {{ JSON.stringify(value3) }}</p>
    </div>

    <div class="demo-item">
      <p class="demo-label">分组 options</p>
      <HxSelect
        v-model="value4"
...
import type { OptionItem, GroupOptionItem } from "@hx/ui"
...
const groupOptions: GroupOptionItem[] = [
  {
    label: "分组 A",
    options: [
