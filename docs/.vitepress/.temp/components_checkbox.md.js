...
const __pageData = JSON.parse('{"title":"Checkbox 多选组","description":"","frontmatter":{},"headers":[],"relativePath":"components/checkbox.md","filePath":"components/checkbox.md"}');
const _sfc_main = { name: "components/checkbox.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_DemoContainer = resolveComponent("DemoContainer");
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="checkbox-多选组" tabindex="-1">Checkbox 多选组 <a class="header-anchor" href="#checkbox-多选组" aria-label="Permalink to &quot;Checkbox 多选组&quot;">​</a></h1><p>基于 Element Plus <code>el-checkbox-group</code> 封装，支持 options 驱动渲染、远程数据源和禁用状态。</p><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2>`);
